...
const colors = ['red', 'green', 'blue', 'yellow', 'orange', 'violet', 'cyan', 'pink']
var win = false;
...
function check() {
    let matches = 0
    let misplaced = 0;
    let pegs = document.querySelector('.row-' + `${rowIndex}`).querySelector('.pegs').querySelectorAll(".peg")
    for(let i = 0; i < 4; i++) {
...
restartButton.addEventListener('click', () => {
    let allCells = document.querySelector('.playable-cells').querySelectorAll('.cell')
